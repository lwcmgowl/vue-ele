...
<style>
  ...
  .star .star-item.star-48 .star-item{
   width: 20px;
   height: 20px;
   margin-right: 22px;
   background-size: 20px 20px !important;
 }
  .star .star-item.star-48 .star-item:last-child{
   margin-right: 0;
 }
  .star .star-item.star-48 .star-item.on{
 ...
 @media (-webkit-min-device-pixel-ratio: 3),(min-device-pixel-ratio: 3) {
  ...
  .star .star-item.star-48 .star-item.half{
 ...
 @media (-webkit-min-device-pixel-ratio: 3),(min-device-pixel-ratio: 3) {
  ...
  .star .star-item.star-48 .star-item.off{
 ...
 @media (-webkit-min-device-pixel-ratio: 3),(min-device-pixel-ratio: 3) {
  ...
  .star .star-item.star-36 .star-item:last-child{
   margin-right: 0;
 }
 ...
 @media (-webkit-min-device-pixel-ratio: 3),(min-device-pixel-ratio: 3) {
  ...
  .star .star-item.star-24 .star-item{
   width: 10px;
   height: 10px;
   margin-right: 3px;
   background-size: 10px 10px !important;
 }
  .star .star-item.star-24 .star-item:last-child{
   margin-right: 0;
 }
  .star .star-item.star-24 .star-item.on{
 ...
 @media (-webkit-min-device-pixel-ratio: 3),(min-device-pixel-ratio: 3) {
  ...
  .star .star-item.star-24 .star-item.half{
 ...
 @media (-webkit-min-device-pixel-ratio: 3),(min-device-pixel-ratio: 3) {
  ...
  .star .star-item.star-24 .star-item.off{
