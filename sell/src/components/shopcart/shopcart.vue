...
<style>
  ...
  .shopcart .content .content-left .logo-wraper {
  ...
  .shopcart .content .content-left .logo-wraper .number {
    position: absolute;
    top: 0;
    right: 0;
    width: 24px;
  ...
  .shopcart .content .content-left .logo-wraper .logo {
    width: 100%;
    height: 100%;
    border-radius: 50%;
    background: #2b343c;
  ...
  .shopcart .content .content-left .logo-wraper .logo.highlight {
    background: rgb(0, 160, 220);
  }

  .shopcart .content .content-left .logo-wraper .logo .icon-shopping_cart.highlight {
    color: #fff;
  }

  .shopcart .content .content-left .logo-wraper .logo .icon-shopping_cart {
    font-size: 24px;
    color: #80858a;
    line-height: 44px;
  }
  ...
  .shopcart .content .content-left .des {
    display: inline-block;
    vertical-align: top;
    line-height: 24px;
